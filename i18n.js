...
const translations = {
    ja: {
        ...
        'cli.win_p1': '公式のMSIインストーラをダウンロードして実行します:',
        'cli.win_li1': '公式ダウンロードリンク (<a href="https://awscli.amazonaws.com/AWSCLIV2.msi" target="_blank" rel="noopener noreferrer">AWSCLIV2.msi</a>) からインストーラをダウンロードします。',
        'cli.win_li2': 'ダウンロードした <code>.msi</code> ファイルを実行し、画面の指示に従います。',
        'cli.win_p2': 'または、コマンドラインからインストールします (管理者権限のPowerShell):',
    ...
    en: {
        ...
        'cli.win_p1': 'Download and run the official MSI installer:',
        ...
        'cli.win_p2': 'Or install via the command line (PowerShell as Administrator):',
